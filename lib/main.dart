      ...
      theme: ThemeData(
        colorScheme: ColorScheme(
          ...
          background: lightMode
              ? colors["soapstone"]!
              : colors["cinder"]!, // warna background halaman
          onBackground: lightMode
              ? colors["cinder"]!
              : colors["soapstone"]!, // warna text dalam halaman
          primary: colors["cerulean-blue"]!, // warna background primary
          onPrimary: colors["soapstone"]!, // warna text dalam primary
          secondary: colors[
              "light-grey"]!, // warna background secondary -> kotak abu-abu
          ...
          surface: lightMode
              ? colors["soapstone"]!
              : colors["cinder"]!, // warna background card
          onSurface: lightMode
              ? colors["cinder"]!
              : colors["soapstone"]!, // warna text dalam card
        ),
        useMaterial3: true,
      ),
